  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://codesandbox.io/u/ashmitaluthra33"
            ...
            <li>
              <a
                href="https://www.instagram.com/__ashmita3/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/ashmita-luthra-01b91b203/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Ashmita</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
